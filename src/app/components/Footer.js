                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        <div className={footerStyles['logo-details']}>
                            ...
                            <span className={footerStyles.logo_name}>Netflix WatchParty</span>
                        </div>
                        <div className={footerStyles[`media-icons`]}>
                            <Link href="#"><i > <FaFacebookF/> </i></Link>
                            <Link href="https://twitter.com/home"><i > <FaTwitter/> </i> </Link>
                            <Link href="https://www.instagram.com/rxshavpal/" target="_blank"><i > <FaInstagram/>  </i></Link>
